...
public class View_Booked_Cab extends JFrame {
    Font f, headerFont;
    JTable t1;
    String[] columnNames = {"Book ID", "Username", "Driver Name", "Car", "Source", "Destination", "Price"};
    String[][] rowData = new String[20][7];
    int i = 0;
    ...
    View_Booked_Cab() {
        ...
        try {
            ...
            String query = "SELECT * FROM intracity_cab";
            ...
            while (resultSet.next() && i < rowData.length) {
                ...
                rowData[i][2] = resultSet.getString("drivername");
                rowData[i][3] = resultSet.getString("car");
                rowData[i][4] = resultSet.getString("source");
                rowData[i][5] = resultSet.getString("destination");
                rowData[i][6] = resultSet.getString("price");
                i++;
            }
